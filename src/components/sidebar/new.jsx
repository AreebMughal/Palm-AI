...
import { IconPlus, Logo, IconLibrary, IconDataset, IconReport, IconTeam, IconNotification, IconSetting, IconLeftLogout, IconHambuger } from 'assets/imgs';
...
export default function New() {
    ...
    function sidebarHandler(flag) {
        ...
        // document.getElementById("mobile-nav").classList.toggle("max-lg:hidden");
    }
    ...
    return (
        <>
            <div class="w-full h-full">
                {/* <span
                    class="absolute text-white text-4xl top-5 left-4 cursor-pointer lg:hidden bg-slate-400"
                ...
                <dh-component>
                    <div class="flex flex-no-wrap">
                        <div class="max-lg:hidden" id='toggle-sidebar'>
                            <Sidebar />
                        </div>
                        <div class="w-64 z-40 absolute bg-gray-800 h-full flex-col justify-between lg:hidden transition duration-150 ease-in-out" id="mobile-nav">
                            <div className='toggle_btn'>
                                <button aria-label="toggle sidebar" id="openSideBar" class="h-10 w-10 bg-gray-800 absolute right-0 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800"
                                    onClick={() => sidebarHandler(true)}>
                                ...
                                <button aria-label="Close sidebar" id="closeSideBar" class="hidden h-10 w-10 bg-gray-800 absolute right-0 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white"
                        ...
                        <div class="lg:mx-auto ml-3 w-full px-0">
